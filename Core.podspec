...
Pod::Spec.new do |spec|
  ...
  # spec.author             = { "dimspawn" => "myzrael005@gmail.com" }
  # Or just: spec.author    = "dimspawn"
  # spec.authors            = { "dimspawn" => "myzrael005@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/dimspawn"
